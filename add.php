...
if (isset($_SESSION['user'])) {
    ...
    $page_content = include_template('error.php', ['error' => 'Незарегистрированным пользователям нельзя добавлять лоты.<br> Пожалуйста зарегистрируйтесь!', 'categories' => $categories]);
}
